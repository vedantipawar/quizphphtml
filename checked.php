...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" > HalloHappiness Survey Test </h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
            ...
            for ($i=1; $i<=$checked_count ; $i++) { 
              $query = "select wtg from answers where aid=$selected[$i]";
            ...
            <br>HIGHER SCORE INDICATES HIGHER SELF ESTEEM (SCALE 0-20)
